...
<div class="custom-control custom-checkbox">
  ...
  <a tabindex="0" style="text-decoration:none;" role="button" data-toggle="popover" data-trigger="focus" title='<center><span class="text-info">Importante</span></center>' data-content="Se esse grupo for definido como '<b class='text-danger'>Exibir grupo de acesso</b>' será mostrado como opção na hora de definir um <b>Responsável Técnico</b> pela ordem de serviço">
