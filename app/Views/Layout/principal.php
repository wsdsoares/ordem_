...
<head>
  ...
  <link href="<?= site_url('recursos/') ?>vendor/swiper/css/swiper-bundle.min.css" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css2?family=Material+Icons" rel="stylesheet">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/noUiSlider/14.6.4/nouislider.min.css">
  <link href="<?= site_url('recursos/') ?>vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
  <link href="<?= site_url('recursos/') ?>vendor/jvmap/jquery-jvectormap.css" rel="stylesheet">
  <link href="https://cdn.datatables.net/buttons/1.6.4/css/buttons.dataTables.min.css" rel="stylesheet">
  <link href="<?= site_url('recursos/') ?>vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet">

  <!-- tagify-css -->
  <link href="<?= site_url('recursos/') ?>vendor/tagify/dist/tagify.css" rel="stylesheet">

  <!-- Style css -->
  <link href="<?= site_url('recursos/') ?>css/style.css" rel="stylesheet">

  <!-- Espaço reservado para renderizar os estilos de cada view e extender esse layout -->
...
<body data-typography="poppins" data-theme-version="light" data-layout="vertical" data-nav-headerbg="black" data-headerbg="color_1">
                  ...
                  <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="header-info2 d-flex align-items-center">
                      ...
                      <div class="header-info">
                        <h6>Você está logado: </h6>
                        <p><?php echo usuario_logado()->nome; ?></p>
                      </div>
                  ...
                  <div class="dropdown-menu dropdown-menu-end" style="">
                    <div class="card border-0 mb-0">
                      <div class="card-header py-2">
                        <div class="products">
                          <img src="<?php echo usuario_logado()->imagem; ?><" class="avatar avatar-md" alt="">
                          <div>
                            <h6><?php echo usuario_logado()->nome; ?></h6>
                            <p><?php echo usuario_logado()->email; ?></p>
                          </div>
                        </div>
                      </div>
  ...
  <script src="<?= site_url('recursos/') ?>vendor/chart.js/Chart.bundle.min.js"></script>
  <script src="<?= site_url('recursos/') ?>vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
  <script src="<?= site_url('recursos/') ?>vendor/apexchart/apexchart.js"></script>

  <!-- Dashboard 1 -->
  <script src="<?= site_url('recursos/') ?>js/dashboard/dashboard-1.js"></script>
  <script src="<?= site_url('recursos/') ?>vendor/draggable/draggable.js"></script>


  <!-- tagify -->
  <script src="<?= site_url('recursos/') ?>vendor/tagify/dist/tagify.js"></script>

  <script src="<?= site_url('recursos/') ?>vendor/datatables/js/jquery.dataTables.min.js"></script>
  <script src="<?= site_url('recursos/') ?>vendor/datatables/js/dataTables.buttons.min.js"></script>
  <script src="<?= site_url('recursos/') ?>vendor/datatables/js/buttons.html5.min.js"></script>
  <script src="<?= site_url('recursos/') ?>vendor/datatables/js/jszip.min.js"></script>
  <script src="<?= site_url('recursos/') ?>js/plugins-init/datatables.init.js"></script>

  <!-- Apex Chart -->

  <script src="<?= site_url('recursos/') ?>vendor/bootstrap-datetimepicker/js/moment.js"></script>
  <script src="<?= site_url('recursos/') ?>vendor/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>


  <!-- Vectormap -->
  <script src="<?= site_url('recursos/') ?>vendor/jqvmap/js/jquery.vmap.min.js"></script>
  <script src="<?= site_url('recursos/') ?>vendor/jqvmap/js/jquery.vmap.world.js"></script>
  <script src="<?= site_url('recursos/') ?>vendor/jqvmap/js/jquery.vmap.usa.js"></script>
